  ...
  <?php
require_once "../Modelos/noticia/conexion.php";
require_once "../Modelos/noticia/noticia.php";
require_once "../Modelos/noticia/crud_noticia.php";
$crud=new CrudNoticia();
$noticia= new Noticia();
//obtiene todos las noticias con el método mostrar de la clase crud
$listaNoticias=$crud->mostrar();
...
<form action="" method="get">
       <input name="insert" class="btn btn-primary " type="submit" value = "Insertar Noticia" />
       ...
       <br></br>
        <table class="table table-striped">
         ...
         <?php foreach ($listaNoticias as $noticia){ // aca puedes hacer la consulta e iterarla con each. ?>
        <tr>
          <td><?php echo $noticia->getTitular() // aca te faltaba poner los echo para que se muestre el valor de la variable.  ?></td>
            <td><?php echo $noticia->getEntrada() ?></td>
            <td><?php echo $noticia->getFecha() ?></td>
            <td><a  class="btn btn-primary" href="../Modelos/noticia/actualizar.php?cod_noticia=<?php echo $noticia->getCodigo()?>&accion=a">Modificar</a></td>
            <td><a  class="btn btn-primary" href="../Modelos/noticia/administrar_noticia.php?cod_noticia=<?php echo $noticia->getCodigo()?>&accion=e" />Eliminar</td>
        </tr>
        <?php
          }
        ?>
