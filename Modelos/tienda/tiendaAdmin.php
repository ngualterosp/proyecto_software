...
<form action="" method="get">
       <input name="insert" class="btn btn-primary " type="submit" value = "Insertar Categoria" />
       ...
       <br></br>
        ...
        <tr>
          <td><?php echo $categoria->getNombre() ?></td>
            ...
            <td><a  class="btn btn-primary" href="actualizar_categoria.php?cod_categoria=<?php echo $categoria->getCodigoCategoria() ?>">Modificar</a></td>
            <td><a  class="btn btn-primary " href="productoXcategoria.php?cod_categoria=<?php echo $categoria->getCodigoCategoria() ?>" />Productos</td>
        </tr>
        <?php
          }
        ?>
