  ...
  <body id="page-top">
    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
        ...
        <center><img src="badbunny_admin.png" width="50%" height="70%"/></center>
        <!-- /.container-fluid -->
        ...
        <footer class="sticky-footer">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright © Your Website 2018   <?php echo $_SESSION['cod_admin'];?></span>
            </div>
          </div>
        </footer>
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">Select "Logout" below if you are ready to end your current session 2.</div>
